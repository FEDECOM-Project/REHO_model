...
set UnitTypes default {'Battery', 'EV', 'NG_Boiler','OIL_Boiler','WOOD_Stove'};
set Units default {'Battery_district', 'EV_district', 'NG_Boiler_district'};              # Set of units
set UnitsOfType{UnitTypes} within Units default {'Battery_district', 'EV_district','NG_Boiler_district'};
