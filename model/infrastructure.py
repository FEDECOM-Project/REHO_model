...
class infrastructure:
    ...
    def set_discretize_unit_size(self):
        ...
        sizes['OIL_Boiler'] = [0, 11.8] #added by N.G.
...
def initialize_units(scenario, grids=None, building_data="building_units.csv", district_data="district_units.csv", district_units=False, storage_units=False):#building_units_EU
...
def initialize_grids(available_grids={'Electricity': {}, 'NaturalGas': {},'Oil': {},'Wood': {}}, file="grids.csv"):#grids_EU
