...
def plot_performance(results, plot='costs', indexed_on='Scn_ID', label='EN_short', filename=None,
    ...
    if plot == 'costs':
        ...
        change_data['EN'] = ['Costs_Unit_inv', 'price', 'CAPEX', 'OPEX', 'Costs [k€/y]', 'Costs', 'TOTEX', ' k€']
    ...
    indexes, data_capex, data_opex = prepare_dfs(df_eco/1000, indexed_on, True)
...
def plot_profiles(df, units_to_plot, style='plotly', label='FR_long', color='ColorPastel', resolution='weekly',
    ...
    for unit in units_to_plot:
        ...
        elif unit in ["Battery", "EV_district", "Battery_district"]:
...
def sunburst_eud(results, label='FR_long', save_path="", filename=None, export_format='html', auto_open=False):
    ...
    classes = ['I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII', 'XIII', 'XIV']
